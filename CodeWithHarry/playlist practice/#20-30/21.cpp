...
An example program to demonstrate classes, public and private access modifiers are shown in below :
...
As shown above, 1st we created an object “harry” of the class “employee”; 2nd we assigned values to “int d” and “int e” which are public class members. If we try to assign values to the private class member’s compiler will throw an error. 3rd we passed the values to the function “setData” and at the end, we called “getData” function which will print the values of all the variables. The output for the following program is shown below:

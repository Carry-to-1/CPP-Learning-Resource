...
As shown in code snippet 2, we have declared an array of size 4 and then assigned values one by one to each index of the array. Output for the following program is shown below :

----------------------------
Output :

These are maths marks of students
23
33
43
44
...
As shown in code snippet 3, we initialized an integer variable “i" with the value 0 and set the running condition of the loop to the length of an array. In the loop body, each index number and the value at each number is being printed. Output for the following program is shown below :
...
An example program for storing the starting address of an array in the pointer is shown below :
...
As shown in above example, we have assigned the address of array “marks” to the pointer variable “*p” and then printed the pointer “*p”. The main thing to note here is that the value at the pointer “*p” is the starting address of the array “marks”. The output for the following program is shown below :
...
The value of marks[0] is : 23
The value of marks[1] is : 33
The value of marks[2] is : 43
The value of marks[3] is : 44
-----------------------------
